...
class LoginInButton extends GetView<LoginPageController> {
  const LoginInButton({super.key, required this.emailTextEditing, required this.passwordTextEditing});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () async {
          await controller.login('admin', 'admin');
          print(controller.successfulLogin.value);
        },
